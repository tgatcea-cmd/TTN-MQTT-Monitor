...
import 'services/iot_brain.dart'; // REQUIRED
import 'design/cyber_theme.dart'; // REQUIRED
import 'screens/dashboard_screen.dart'; // REQUIRED
...
void main() async {
  ...
  runApp(
    MultiProvider(
      providers: [ChangeNotifierProvider(create: (_) => IoTBrain())],
      child: const MainApp(),
    ),
  );
}
...
class MainApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      theme: CyberTheme.theme, // Apply the custom theme
      home: const SafeArtDashboard(), // Use the new dashboard
    );
  }
}
